...
const CourseCart = ({ media, ctaText, checklist }: any) => {
  return (
    <div className="w-full md:max-w-[330px] lg:max-w-[400px] order-2 bg-white absolute right-0 md:top-[50px] md:absolute border border-gray-300">
      {/* Not sticky wrapper anymore */}
      <MediaCarousel media={media} />
      
      {/* Make this div sticky */}
      <div className="sticky top-[112px] z-10 bg-white">
